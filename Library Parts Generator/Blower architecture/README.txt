...
1. Save the Blower_Master.xml and Fan_Write.xlsm into your own directory

2. Open the "Blower_Write" Excel File
...
10. Select the Blower_Write macro and click run
...
%=============================== Sheet 5 ========================================
Stores what each of the acronyms mean.
They can be found used in the Blower_Master.xml

Please do not change any of these acronyms as this is what the code uses to
reference the keywords in the .xml file, unless you change it on the .xml file
as well.

In the fan and heatsink templates, it automatically uses the header names so do
not require a 5th sheet.

They use header names and this doesn't because it is not a built in smart part
in FloTHERM.
